...
public class FilmDbStorage implements FilmStorage {
    ...
    public Film create(Film film) {
        ...
        jdbcTemplate.update(connection -> {
            ...
            ps.setObject(5, film.getMpa() != null ? film.getMpa().getMpa_id() : null, Types.INTEGER);
            return ps;
        }, keyHolder);
    ...
    public Film update(Film film) {
        ...
        jdbcTemplate.update(sql,
                ...
                film.getDuration(),
                film.getMpa() != null ? film.getMpa().getMpa_id() : null,
                film.getId());
    ...
    private void saveFilmGenres(int filmId, Set<Genre> genres) {
        ...
        List<Genre> validGenres = genres.stream()
                .filter(g -> g != null && g.getGenre_id() != null)
    ...
    private boolean isValidFilm(Film film) {
        ...
        if (film.getMpa().getMpa_id() < 1 || film.getMpa().getMpa_id() > 5) {
            throw new NotFoundException("MPA ID должен быть от 1 до 5");
        }
        for (Genre genre : film.getGenres()) {
            if (genre.getGenre_id() < 1 || genre.getGenre_id() > 6) {
